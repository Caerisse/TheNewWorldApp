...
import { appTheme, tabs } from '../../constants/examples';
import { Button, Select, Icon, Input, Header, Switch } from '../../components/examples';
...
const styles = StyleSheet.create({
  ...
  inputDefault: {
    borderBottomColor: appTheme.COLORS.PLACEHOLDER,
  },
  inputTheme: {
  ...
  inputWarning: {
    borderBottomColor: appTheme.COLORS.WARNING,
  },
  inputDanger: {
...
class Elements extends React.Component {
  constructor() {
    ...
    this.toggleSwitch = (switchId) => this.setState({ [switchId]: !this.state[switchId] });
  }
  // state = {
  //   "switch-1": true,
  //   "switch-2": false
            ...
            iconContent={
              <Block
                ...
                style={{
                  ...
                  height: 20,
                  borderRadius: 10,
                  backgroundColor: appTheme.COLORS.INPUT_SUCCESS,
                }}
              >
                <Icon
                  size={11}
            ...
            iconContent={
              <Block
                ...
                style={{
                  ...
                  height: 20,
                  borderRadius: 10,
                  backgroundColor: appTheme.COLORS.INPUT_ERROR,
                }}
              >
                <Icon
                  size={11}
    ...
    return (
      <Block flex style={styles.group}>
        ...
        <Block>
          ...
          <Block style={{ marginBottom: theme.SIZES.BASE }}>
            <Header
              white back title="Title"
              navigation={this.props.navigation}
              bgColor={appTheme.COLORS.ACTIVE}
              titleColor="white"
              iconColor="white"
            />
          </Block>
